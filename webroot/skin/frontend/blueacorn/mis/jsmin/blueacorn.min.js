    ...
    layeredNavigation.prototype = {
        ...
        toggleFilter: function() {
            $("#narrow-by-list dt").on("click", function() {
                var self = $(this), filters = "current", items = "current", itemBlock = "dd";
...
jQuery(document).ready(function($) {
    ...
    productPage.prototype = {
        ...
        imageSlider: function() {
            var self = this, relatedContainer = $(".products-grid.owl-carousel-1"), upsellContainer = $(".products-grid.owl-carousel-2");
        ...
        setDescriptionContainerMaxHeight: function() {
            var self = this, wrapper = $(".description"), container = $(".description .detail"), divHeight = $(".specifications");
            container.css({
                "max-height": divHeight.height()
            });
            if (container[0].scrollHeight > container.innerHeight()) {
                wrapper.append('<div class="read-more">Read More</div>');
                $(".read-more").css({
                    top: wrapper.height() + 4
                });
            }
        },
        expandDescription: function() {
            var self = this, readMore = $(".read-more"), container = $(".description .detail"), newHeight = $(".detail")[0].scrollHeight;
        ...
        setupAccordion: function() {
            var self = this, title = $(".column-right .column-container h2");
            title.on("click", function() {
                $(this).toggleClass("open-links");
            });
        },
        moveAddToCartButton: function() {
            var self = this, button = $(".add-to-cart-buttons"), links = $(".add-to-links");
            enquire.register("screen and (max-width:" + bp.medium + "px)", {
                match: function() {
        ...
        thumb: function() {
            var self = this, thumb = $(".thumb-link img");
