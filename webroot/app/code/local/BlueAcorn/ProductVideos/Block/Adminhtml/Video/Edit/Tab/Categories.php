 ...
 */
/**
 * video - categories relation edit block
 *
 * @category    BlueAcorn
 * @package     BlueAcorn_ProductVideos
 *
 */
class BlueAcorn_ProductVideos_Block_Adminhtml_Video_Edit_Tab_Categories
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('blueacorn_productvideos/video/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }
    /**
     * Retrieve currently edited product video
     * @access public
    ...
    /**
     * Return array with categories IDs which the product video is linked to
     * @access public
     * @return array
     *
     */
    public function getCategoryIds(){
        if (is_null($this->_categoryIds)){
            $categories = $this->getVideo()->getSelectedCategories();
                $ids = array();
     ...
     * Returns root node
     *
     * @param BlueAcorn_ProductVideos_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current product video)
     *
     * @return array
     */
