    ...
    public function capture(Varien_Object $payment, $amount)
    {
        ...
        if (!empty($order))
        {
            ...
            $request->setComment1($customerSWId) // set comment1 to be the Southware Customer ID
                    ->setComment2($orderSWId); // set comment2 to be the Southware Order ID
        }
        // end added VHC
    ...
    protected function _buildPlaceRequest(Varien_Object $payment, $amount)
    {
        ...
        if (!empty($order)) {
            ...
            $request->setCurrency($order->getBaseCurrencyCode())
                ...
                ->setComment1("SW Customer ID") // VHC set comment2 to be the Southware Customer ID placeholder
                ->setComment2("SW Order ID"); // VHC set comment2 to be the Southware  Order ID placeholder
