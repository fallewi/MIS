 ...
 */
class MissionRS_AmastyOrderAttributeFix_Block_Adminhtml_Order_Create_Form_Attributes extends Amasty_Orderattr_Block_Adminhtml_Order_Create_Form_Attributes
{
    ...
    public function getFormElements()
    {
        ...
        {
            // VHC additional logic to leave out custom attribute on order creation
            if ('customer_note' == $attribute->getAttributeCode()||
                'dropship_po' == $attribute->getAttributeCode()||
                'guest_sw_customer_id' == $attribute->getAttributeCode() ||
                'referring_domain' == $attribute->getAttributeCode() ||
                'referring_keyword' == $attribute->getAttributeCode() ||
                'southware_order_id' == $attribute->getAttributeCode() ||
                'southware_transfer_id' == $attribute->getAttributeCode() ||
                'special_order' == $attribute->getAttributeCode() ||
                'tracking_first' == $attribute->getAttributeCode() ||
                'tracking_last' == $attribute->getAttributeCode())
            {
                continue;
            }
            // End VHC additional logic to leave out custom attribute on order creation
