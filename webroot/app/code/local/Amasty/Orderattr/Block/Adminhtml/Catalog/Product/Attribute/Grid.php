...
class Amasty_Orderattr_Block_Adminhtml_Catalog_Product_Attribute_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumnAfter('is_visible', array(
            ...
            'filter_index'=>'additional_table.is_visible_on_front',
            'type' => 'options',
            'options' => array(
