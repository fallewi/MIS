...
//            'class' => 'no-display',
        ...
        $groupEnabled = $fieldset->addField('customer_group_enabled', 'select', array(
            'name' => 'customer_group_enabled',
            'label' => Mage::helper('amorderattr')->__('Show For Selected Customer Groups Only'),
            'title' => Mage::helper('amorderattr')->__('Show For Selected Customer Groups Only'),
            'values' => $yesno,
            'value' => $model->getDefaultValue(),
        ));

        $groups = $fieldset->addField('customer_groups', 'multiselect', array(
            'name'      => 'customer_groups[]',
            'label'     => Mage::helper('amorderattr')->__('Customer Groups'),
            'title'     => Mage::helper('amorderattr')->__('Customer Groups'),
            'values'    => Mage::getModel('amorderattr/source_group')->toOptionArray(),
        ));
