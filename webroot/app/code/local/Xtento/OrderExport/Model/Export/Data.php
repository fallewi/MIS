 ...
 * Last Modified: 2018-02-20T13:25:02+01:00
...
class Xtento_OrderExport_Model_Export_Data extends Mage_Core_Model_Abstract
{
    ...
    protected function _getRegisteredExportData()
    {
    ...
    protected function _loadExportDataFile($exportDataFile, $throwFileException = true)
    {
    ...
    protected function _addPrivateFields($collectionItem, $exportData)
    {
        $privateFields = array();
