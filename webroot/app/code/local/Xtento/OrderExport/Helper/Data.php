 ...
 * Last Modified: 2018-06-25T16:52:04+02:00
...
class Xtento_OrderExport_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        $cacheKey = 'xtento_orderexport_module_properly_installed';
        $cachedData = @unserialize(Mage::app()->getCache()->load($cacheKey));
        if ($cachedData === true) {
            return true;
        }
        ...
        if (self::$_isModuleProperlyInstalled !== null) {
            ...
            if (self::$_isModuleProperlyInstalled === true) {
                Mage::app()->getCache()->save(serialize(true), $cacheKey, array(), 3600);
            }
            return self::$_isModuleProperlyInstalled;
        }
    }
