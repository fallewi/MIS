...
class Cminds_MultiUserAccounts_Block_Adminhtml_SubAccount_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        ...
        if ($subAccount && $subAccount->getId()) {
            return Mage::helper('cminds_multiuseraccounts')->__("Edit Sub Account '%s'",
                $this->escapeHtml($subAccount->getName()));
        } else {
    ...
    public function getBackUrl()
    {
        ...
        return $this->getUrl('*/customer/edit/tab/customer_info_tabs_customer_edit_tab_subaccount',
            array('id' => $customerId));
    }
